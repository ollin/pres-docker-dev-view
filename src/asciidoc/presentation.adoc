...
image::https://i.creativecommons.org/l/by/4.0/88x31.png["Creative Commons License", alt="Creative Commons License", float="center", link="http://creativecommons.org/licenses/by/4.0/"]
