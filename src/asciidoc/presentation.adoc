...
* 14'000+ dockerisierte Applikationen
* 2014 15M + 40M
* 3,200 forks, and nearly 700 contributors

== Docker - weitere Themen

* https://docs.docker.com/swarm/[Docker Swarm] - Clustering, pool of containers into single, virtual host
* http://boot2docker.io/[boot2docker] - lightweight Linux distribution for OS X and Windows, 5 sec, ~27 MB,
